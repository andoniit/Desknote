export const DEVICE_ACCENTS = [
  ...
  { id: "blush", label: "Blush", swatch: "bg-blush-300" },
  { id: "plum", label: "Plum", swatch: "bg-plum-300" },
  { id: "sage", label: "Sage", swatch: "bg-[#A8B5A0]" },
  { id: "cream", label: "Cream", swatch: "bg-cream-200" },
] as const;
